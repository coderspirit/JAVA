...
public class AboutNotepad extends JFrame {
	...
	this.setLocationRelativeTo(null);
		...
		lblNewLabel.setIcon(new ImageIcon(AboutNotepad.class.getResource("anurudh.jpg")));
		lblNewLabel.setBounds(336, 11, 85, 115);
		this.getContentPane().add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Anurudh Ojha");
		lblNewLabel_1.setFont(new Font("Broadway", Font.BOLD, 11));
		lblNewLabel_1.setBackground(Color.RED);
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setBounds(328, 137, 100, 14);
