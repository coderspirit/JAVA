...
public class Board extends JPanel {
	...
	public void paintComponent(Graphics g){
		...
		twod.drawString("Enemy Left : "+enemyList.size(), 20, 30);
		twod.drawString("Enemy Kill : "+countKillEnemy, 400, 30);
		...
		for(int i=0;i<enemyList.size();i++){
			...
			for(int j=0;j<missilesList.size();j++)
			{
				...
				if(missile.getX()>=GameScreen.BOARD_WIDTH){
	...
	public Board() {
		...
		setBounds(0, 0, GameScreen.BOARD_WIDTH, GameScreen.BOARD_HEIGHT);
